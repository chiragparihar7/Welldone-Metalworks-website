    ...
    <section className="py-10 px-6 bg-gradient-to-b from-gray-150 to-gray-300">
      ...
      <div className="max-w-[1280px] mx-auto text-center mb-16">
        ...
        <p className="text-gray-700 mt-4 max-w-3xl mx-auto">
          Whether you have a question, a project idea, or need a quote, our team
          is ready to assist you. Fill out the enquiry form or reach out through
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Reach out to discuss your fabrication project, ask questions, or
            ...
            <div className="space-y-5 text-gray-700">
              ...
              <p className="flex items-center gap-3">
                <MapPin size={20} className="text-yellow-500" /> 2 Laxmi Chuna
                Factory, Sola Gham, Ahmedabad
              </p>
            </div>
          </div>
